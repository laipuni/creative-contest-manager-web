 ...
 */
@Slf4j
public class PreliminaryCertificateExporter implements CertificateExporter{

    //앞에 "/" 붙일경우 절대 경로로 해석되어 templates아래의 html을 인식못할 수 있으니 주의
    public static final String PRELIMINARY_CERTIFICATE_FORM_PATH = "certificate/preliminary-certificate";

    private final CertificateGenerator certificateGenerator;
    private final TemplateRenderer templateRenderer;

    public PreliminaryCertificateExporter(final CertificateGenerator certificateGenerator, final TemplateRenderer templateRenderer) {
