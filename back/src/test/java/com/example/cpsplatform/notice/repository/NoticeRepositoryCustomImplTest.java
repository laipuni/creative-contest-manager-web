...
class NoticeRepositoryCustomImplTest {
    ...
    void searchByTitleWithOnlyMatchingTitle() {
        //given
    ...
    void sortByViewCountDesc_shouldReturnInDescendingOrder() {
        //given
        Member admin = createAndSaveAdmin("adminLoginId");
    ...
    void sortByCreatedAtAsc_shouldReturnInAscendingOrder() throws InterruptedException {
        //given
        Member admin = createAndSaveAdmin("adminLoginId");
    ...
    void paging_shouldLimitToPageSizeAndPreserveTotalCount() {
        //given
        Member admin = createAndSaveAdmin("adminLoginId");
